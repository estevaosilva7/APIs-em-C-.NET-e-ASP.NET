...
namespace MinhaPrimeiraAPI.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IEnumerable<UsuarioModel> Get()
        {
            ...
            usuarioModels.Add(new UsuarioModel() { Id = 1, Nome = "Estevão", Email = "estevao@gmail.com" });
        ...
        {
            UsuarioModel usuario = new UsuarioModel() { Id = 1, Nome = "Estevão", Email = "estevao@gmail.com" };
